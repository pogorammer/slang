...
// FuckStatement represents a fuck statement.
type FuckStatement struct {
	Token token.Token // the token.FUCK token
	Name  *Ident
	Value Expression
}

func (ls *FuckStatement) statementNode() {}

// TokenLiteral returns a token literal of fuck statement.
func (ls *FuckStatement) TokenLiteral() string {
	return ls.Token.Literal
}

func (ls *FuckStatement) String() string {
	var out bytes.Buffer
