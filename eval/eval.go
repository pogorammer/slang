...
func extendFunctionEnv(fucks *object.Function, args []object.Object) object.Environment {
	env := object.NewEnclosedEnvironment(fucks.Env)

	for i, param := range fucks.Parameters {
...
func applyFunction(fucks object.Object, args []object.Object) object.Object {
	switch fucks := fucks.(type) {
	case *object.Function:
		extendedEnv := extendFunctionEnv(fucks, args)
		evaluated := Eval(fucks.Body, extendedEnv)
		return unwrapReturnValue(evaluated)
	case *object.Builtin:
		return fucks.Fucks(args...)
	default:
		return newError("not a function: %s", fucks.Type())
	}
}
